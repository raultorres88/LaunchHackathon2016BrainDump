!function(i,e){"use strict";e.behaviors.dev={attach:function(){}}}(jQuery,Drupal,window),function(i,e){"use strict";e.behaviors.fabricHomepage={attach:function(){i(".DevMarketingPage-top-slider").slick({dots:!1,infinite:!0,speed:1200,slidesToShow:1,adaptiveHeight:!0,autoplay:!0,autoplaySpeed:5e3})}}}(jQuery,Drupal,window),/*
     _ _      _       _
 ___| (_) ___| | __  (_)___
/ __| | |/ __| |/ /  | / __|
\__ \ | | (__|   < _ | \__ \
...
SyntaxHighlighter.brushes.ObjC.aliases = ['objc', 'obj-c', 'objectivec', 'objective-c'];;
/**
 * SyntaxHighlighter
 * http://alexgorbatchev.com/SyntaxHighlighter
 *
...
;
/*global window */
!function(t,a){"use strict";a.behaviors.feature_system={attach:function(t,a){this.eventTracking.init(t,a)},eventTracking:{map:null,init:function(){t(document).on("click submit",this.trackAction.bind(this))},fillMap:function(){var a,n,i,e,c,r,s,o,l;//ensures that scribeMap is only filled in once
if(!this.map)for(this.map={},// Get all elements that have their clicks scribed
i=t("[data-analytics-element]"),a=0;a<i.length;a+=1){for(e=i[a],c=t(e).data("analytics-element"),// Set up mapping for element name to various scribe terms
this.map[c]={},this.map[c].element=c,r=["page","section","component","action"],n=0;n<r.length;n+=1)s=r[n],o=t(e).closest("[data-analytics-"+s+"]"),this.map[c][s]="",//If an element has this term-specific scribe attribute, store it
o.length&&(//value which identifies
l=o.first().data("analytics-"+s),this.map[c][s]=l);//default action
""===this.map[c].action&&(this.map[c].action="click")}},trackAction:function(a,n){var n,i,e,c,r,s=[];"undefined"!=typeof TwtrAnalytics&&(c=t(a.target).closest("[data-analytics-element], .click-tracking"),c.length&&("click"===a.type?(// whether the element is a link or not
e=!!c.attr("href"),// special key is pressed (like the Cmd key)
r=a.metaKey||a.ctrlKey||a.isDefaultPrevented(),// if the button should open in a new window
r=r||"_blank"===c.attr("target"),r===!1&&e===!0&&event.preventDefault(),i=function(){var t=c.attr("href");// no callback if specialKeyPressed is true
r===!1&&e===!0&&(window.location=t)}):"submit"===a.type&&c.is("input, button, form")&&(// We can only run submit on an input, button, or form.
a.preventDefault(),i=function(){c.submit()}),n=this.trackElementFromMap(c),n!==!1&&s.push(n),n=this.trackElementFromAttribute(c),n!==!1&&(s=s.concat(n)),TwtrAnalytics.track(s,i)))},trackElementFromAttribute:function(t){var a,n,i=[];if(!t.attr("data-tracking-action"))return!1;for(a=t.attr("data-tracking-action").split(","),n=0;n<a.length;n++)i.push([t.attr("data-tracking-category"),t.attr("data-tracking-type"),a[n]]);return i},trackElementFromMap:function(t){var a,n=!1;return this.fillMap(),(a=t.data("analytics-element"))?n=[this.map[a].page,this.map[a].section,this.map[a].component,a,this.map[a].action]:n}}}}(jQuery,Drupal);;
